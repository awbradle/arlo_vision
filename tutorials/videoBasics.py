...
frame_w_middle = int(frame_width / 2)
frame_height = int(cap.get(4))
frame_h_middle = int(frame_height / 2)
...
while(True):
  ...
  # Draw a white x in the middle of the screen
  cv2.line(frame,((frame_w_middle-20),(frame_h_middle-20)),((frame_w_middle+20),(frame_h_middle+20)),(255,255,255),2)
  cv2.line(frame,((frame_w_middle-20),(frame_h_middle+20)),((frame_w_middle+20),(frame_h_middle-20)),(255,255,255),2)
